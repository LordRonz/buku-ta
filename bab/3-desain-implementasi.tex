...
Kemudian dari urutan aliran data akan dijelaskan pada bagan \ref{fig:alirdata}.
\begin{figure}[H]
  \centering
...
Pada contoh terdapat user A yang menyiapkan JSON dan audio di IPFS, lalu dilakukan Mint URL di smart contract UI.
